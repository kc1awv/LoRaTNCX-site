...
- Start with [Section 1: Introduction](manual/introduction) if you're new to LoRaTNCX
- Follow [Section 2: Getting Started](manual/getting-started) for initial setup
